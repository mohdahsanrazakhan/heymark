...
const Skill = () => {
  return (
    <section className='my-10'>
      <h1 className='text-[4rem] sm:text-[6rem] landing-none font-[clash-display-semibold] text-center w-full m-auto text-[#131313] dark:text-[#CFC1AE]'>My Skills</h1>
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 justify-center items-center place-content-center w-fit m-auto gap-5'>
        ...
        <ToolCard skill="TypeScript" url="https://raw.githubusercontent.com/devicons/devicon/master/icons/typescript/typescript-original.svg" alt="typescript" />
        ...
        <ToolCard skill="Next.js" url="https://raw.githubusercontent.com/devicons/devicon/master/icons/nextjs/nextjs-original.svg" alt="nextjs" />
        ...
        <ToolCard skill="TailwindCSS" url="https://raw.githubusercontent.com/devicons/devicon/master/icons/tailwindcss/tailwindcss-original.svg" alt="tailwindcss" />
