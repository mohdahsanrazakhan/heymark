  ...
  return (
    <section className="flex lg:flex-row flex-col gap-10 lg:gap-0 justify-center items-center min-h-[100vh] lg:mx-28">
      <div className="flex flex-col mx-10 sm:m-0 sm:w-1/2">
        ...
        <a className="email text-[1.2rem] sm:text-[1.5rem] sm:pt-1 pt-3 landing-none sm:font-[clash-display-semibold] font-mono sm:font-normal font-semibold ml-auto" href="mailto:khanmohdahsanraza@gmail.com">khanmohdahsanraza@gmail.com</a>
      </div>
      <div className="flex flex-wrap px-10 mb-10 lg:mb-0 sm:px-0 w-full sm:w-1/2 justify-center items-center">
        <p className="text-[1.2rem] landing-none font-mono w-[25rem] lg:ml-auto m-auto text-center lg:text-left">I'm currently available for new work. Let me know if you're looking for a Front-end Developer. Let's talk about the next big thing!</p>
      </div>
    </section>
  )
}
